...
Source: "{#BINDIR}\Images\*.png"; DestDir: "{app}\Images\Palettes"; Flags: ignoreversion createallsubdirs recursesubdirs
Source: "{#BINDIR}\Palettes\*.thd"; DestDir: "{app}\Palettes"; Flags: ignoreversion createallsubdirs recursesubdirs
