...
namespace Microsoft.Research.ScientificDataSet.NetCDF4
{
    ...
    {
        [DllImport("netcdf4.dll", CharSet=CharSet.Unicode)]
        ...
        [DllImport("netcdf4.dll", CharSet = CharSet.Ansi)]
        ...
        [DllImport("netcdf4.dll", CharSet = CharSet.Ansi)]
        public static extern int nc_get_var_double(int ncid, int varid, float[] data);
        ...
        [DllImport("netcdf4.dll")]
        public static extern int nc_get_att_double(int ncid, int varid, string name, float[] data);

        [DllImport("netcdf4.dll")]
        public static extern int nc_put_att_text(int ncid, int varid, string name, int len, string tp);
        [DllImport("netcdf4.dll")]
        public static extern int nc_put_att_double(int ncid, int varid, string name, NcType type, int len, float[] tp);
        [DllImport("netcdf4.dll")]
        ...
        [DllImport("netcdf4.dll")]
        public static extern int nc_put_vara_double(int ncid, int varid, int[] start, int[] count, float[] dp);
        [DllImport("netcdf4.dll")]
        ...
        [DllImport("netcdf4.dll")]
        public static extern int nc_get_vara_double(int ncid, int varid, int[] start, int[] count, float[] data);
        [DllImport("netcdf4.dll")]
