...
{
    public class DualJet_WithReversal : JetLevel
    {
        public DualJet_WithReversal(EarthModel earth, bool loadFromStateFiles, float defaultValue = 0) :
            ...
            float daysElapsed, float dailyJetAdvance, float deltaLonRad)
        {
            ...
            (
                ...
                (r, c) =>
                {
                    ...
                    var f = JetModelFunctions.DualJet_WithReversal(Earth.UTC.DayOfYear, latRad);
