...
{
    public class DualJet_WithReversal_FastFluidDynamicsJet : Ffd_JetLevel
    {
        public DualJet_WithReversal_FastFluidDynamicsJet(EarthModel earth, bool loadFromStateFiles, float defaultValue = 0) :
