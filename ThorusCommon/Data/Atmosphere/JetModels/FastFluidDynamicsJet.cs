...
{
    public class FastFluidDynamicsJet : Ffd_JetLevel
    {
        public FastFluidDynamicsJet(EarthModel earth, bool loadFromStateFiles, float defaultValue = 0) :
            ...
            try
            {
                ...
                (
                    ...
                    (r, c) =>
                    {
                        ...
                        float ridgeDevX = (float)ffd.u[c + 1, r + 1, 1];
                 ...
                 (r, c) =>
                 {
                     ...
                     float lon = c - 180;
                         ...
                         float ridgeDevY = (float)ffd.v[c + 1, r + 1, 1];
