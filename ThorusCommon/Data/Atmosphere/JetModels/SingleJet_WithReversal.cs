...
{
    public class SingleJet_WithReversal : JetLevel
    {
        public SingleJet_WithReversal(EarthModel earth, bool loadFromStateFiles, float defaultValue = 0) :
            ...
            float daysElapsed, float dailyJetAdvance, float deltaLonRad)
        {
            ...
            (
                ...
                (r, c) =>
                {
                    ...
                    var f = JetModelFunctions.SingleJet_WithReversal(Earth.UTC.DayOfYear, latRad);
