...
{
    public class VariableJet_WithReversal : JetLevel
    {
        public VariableJet_WithReversal(EarthModel earth, bool loadFromStateFiles, float defaultValue = 0) :
            ...
            float daysElapsed, float dailyJetAdvance, float deltaLonRad)
        {
            ...
            (
                ...
                (r, c) =>
                {
                    ...
                    var fSingle = JetModelFunctions.SingleJet_WithReversal(Earth.UTC.DayOfYear, latRad);
                    var fDual = JetModelFunctions.DualJet_WithReversal(Earth.UTC.DayOfYear, latRad);
